-- ========================================
-- COMPLETE DATABASE SETUP FOR MICRO CREDIT UPI
-- ========================================
-- Run this entire script in Supabase SQL Editor
-- This will create all tables, functions, and setup needed for the app
...
CREATE TRIGGER IF NOT EXISTS update_wallets_updated_at BEFORE UPDATE ON public.wallets
FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER IF NOT EXISTS update_kyc_updated_at BEFORE UPDATE ON public.kyc FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
